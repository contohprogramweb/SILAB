        ...
        <div class="col-md-8 offset-md-2">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="<?= site_url('user/add'); ?>" method="post" id="formAddUser">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="name" id="name" class="form-control" 
                                   placeholder="Masukkan nama lengkap" value="<?= set_value('name'); ?>" required>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select name="role" id="role" class="form-control" required>
                                ...
                                <?php foreach ($roles as $role): ?>
                                    <option value="<?= $role; ?>" <?= set_select('role', $role); ?>>
                                        <?= ucfirst($role); ?>
                                    </option>
                                <?php endforeach; ?>
                            </select>
