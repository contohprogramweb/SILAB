...
<head>
  ...
  <title>AdminLTE 3 | <?php echo isset($page_title) ? $page_title : 'Dashboard'; ?></title>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="<?php echo site_url('auth/logout'); ?>" class="nav-link text-danger">
...
<!-- jValidate - Form Validation Plugin -->
<script src="https://cdn.jsdelivr.net/npm/jvalidate@1.0.5/dist/jquery.jvalidate.min.js"></script>
<!-- DataTables & Plugins -->
